...
export const nav: NavItem[] = [
  ...
  { icon: ClipboardCheck, label: "Task Reviews", to: "/task-reviews", badge: 32 },
  { icon: Video, label: "Live Sessions", to: "/live-sessions" },
  { icon: FileText, label: "Assessments", to: "/assessments" },
  { icon: FolderKanban, label: "Projects", to: "/projects" },
  { icon: Award, label: "Certificates", to: "/certificates" },
  { icon: BarChart3, label: "Analytics", to: "/analytics" },
  { icon: MessagesSquare, label: "Community", to: "/community" },
  { icon: Bell, label: "Notifications", to: "/notifications", badge: 8 },
    ...
    <div className="flex min-h-screen bg-background">
      <aside className="hidden lg:flex w-64 shrink-0 flex-col bg-sidebar text-sidebar-foreground sticky top-0 h-screen">
        ...
        <div className="m-3 rounded-2xl bg-white/5 p-4 border border-white/10">
          ...
          <Link to="/profile-settings" className="mt-4 w-full flex items-center justify-center gap-2 rounded-lg bg-sidebar-active text-white text-xs font-semibold py-2.5 hover:opacity-90">
